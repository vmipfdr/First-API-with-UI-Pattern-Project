...
// let getMoreOpportunityPics = document.querySelector('.randomOpportunityButton');
// getMoreOpportunityPics.addEventListener('click', moreOpportunityPics);
let randomCur = document.querySelector('.randomCuriosityButton');
randomCur.addEventListener('click', getMoreCuriosity);
// let getMoreCuriosityPics = document.querySelector('.randomCuriosityButton');
// getMoreCuriosityPics.addEventListener('click', moreCuriosityPics);
...
// function moreOpportunityPics(){
//   for (let i = 0; i <=1; i++) {
//   }
//   let opportunityImg = res.photos[i].img_src
//   randomMarsPic.setAttribute('src', opportunityImg)
// }

// function moreCuriosityPics(){
//   for (let j = 0; j <=1; j++) {
//   }
...
function getMoreOpportunity(event){
...
function getMoreCuriosity(event){
  event.preventDefault();
